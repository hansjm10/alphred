import { parseCleanupStoryWorkspaceRequest } from '../../../_shared/work-item-route-validation';
...
export async function POST(request: Request, context: WorkItemActionRouteContext): Promise<Response> {
  return handleWorkItemActionPost({
    ...
    parseRequest: parseCleanupStoryWorkspaceRequest,
    execute: (service, cleanupRequest) => service.cleanupStoryWorkspace(cleanupRequest),
  });
}
