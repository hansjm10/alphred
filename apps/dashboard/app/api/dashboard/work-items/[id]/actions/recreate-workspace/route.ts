import { parseRecreateStoryWorkspaceRequest } from '../../../_shared/work-item-route-validation';
...
export async function POST(request: Request, context: WorkItemActionRouteContext): Promise<Response> {
  return handleWorkItemActionPost({
    ...
    parseRequest: parseRecreateStoryWorkspaceRequest,
    execute: (service, recreateRequest) => service.recreateStoryWorkspace(recreateRequest),
  });
}
