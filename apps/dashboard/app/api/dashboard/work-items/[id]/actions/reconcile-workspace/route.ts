import { parseReconcileStoryWorkspaceRequest } from '../../../_shared/work-item-route-validation';
...
export async function POST(request: Request, context: WorkItemActionRouteContext): Promise<Response> {
  return handleWorkItemActionPost({
    ...
    parseRequest: parseReconcileStoryWorkspaceRequest,
    execute: (service, reconcileRequest) => service.reconcileStoryWorkspace(reconcileRequest),
  });
}
