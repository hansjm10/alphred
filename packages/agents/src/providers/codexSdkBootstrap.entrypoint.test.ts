...
describe('codex sdk bootstrap entrypoint resolution', () => {
  ...
  it('caches the bootstrap result when initialized without overrides', () => {
    ...
    const expectedBinaryPath = `/virtual/node_modules/@openai/codex-sdk/vendor/${runtimeTargetTriple}/codex/${binaryName}`;
    ...
    expect(createRequireResolveMock).toHaveBeenCalledTimes(1);
