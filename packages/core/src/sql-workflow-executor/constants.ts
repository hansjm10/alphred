...
export const JOIN_SUMMARY_RESERVED_CHARS = 8_000;
...
export const FAILED_COMMAND_OUTPUT_SCHEMA_VERSION = 1;
export const FAILED_COMMAND_OUTPUT_ARTIFACT_KIND = 'failed_command_output_v1';
